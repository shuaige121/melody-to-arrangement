...
def c_major_melody():
    ...
    return [
        Note(note_number=60 + i, velocity=80, start_tick=i * 480, duration_tick=480, channel=0)
...
def simple_melody():
    ...
    for i, p in enumerate(pitches):
        notes.append(Note(note_number=p, velocity=80, start_tick=i * 480, duration_tick=480, channel=0))
    return notes
